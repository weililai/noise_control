...
T = 20  #温度
c = 331 + 0.6*T  #空气声速
E = 212*10**9  #铝的杨氏模量 69*10**9 #钢的杨氏模量 212*10**9
niu = 0.31  #铝的泊松比 0.34  #钢的泊松比0.31
rho = 7.85*10**3  #铝的密度2.7*10**3 #钢的密度7.85*10**3
D = 0.275  #裸管道直径
l = 0.04  #吸声层厚
...
noise_before_input = np.array([106]) #实测噪声，倍频程7分量向量（dB），如[71.1,67.3,73.9,84.1,91.5,93.2,88.4]；或单个A计权值（dBA），如[100]
control_valve_correction = np.array([20,16,17,9,6,5,7])
