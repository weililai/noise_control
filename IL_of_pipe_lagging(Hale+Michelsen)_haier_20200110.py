...
noise_before_input = np.array([71.1,67.3,73.9,84.1,91.5,93.2,88.4]) #实测噪声，倍频程7分量向量（dB），如[71.1,67.3,73.9,84.1,91.5,93.2,88.4]；或单个A计权值（dBA），如[100]
...
equipment_noise_correction = centrifugal_compressor_correction #选择连接设备，将A计权总值转线性谱修正值，可选项暂有上面4行中的项
